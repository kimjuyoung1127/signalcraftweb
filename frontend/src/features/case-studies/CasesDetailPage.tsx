                ...
                {cases.map((story, i) => (
                    ...
                    >
                        ...
                        <div className="w-full md:w-1/2">
                            <div className={`aspect-video rounded-3xl ${story.image} bg-opacity-10 relative overflow-hidden shadow-2xl`}>
                                <div className="absolute inset-0 bg-gradient-to-br from-black/0 to-black/40" />
                                <div className="absolute top-6 left-6 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20 text-white font-semibold">
                                    {story.client}
                                </div>
                                {/* Placeholder Visuals */}
                        ...
                        <div className="w-full md:w-1/2 space-y-6">
                            <div className="text-blue-600 font-bold uppercase tracking-wider text-sm flex items-center gap-2">
